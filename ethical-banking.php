...
?>
	...
	<div id="banner" class="banner-ethical-banking">

		<div class="banner-title">
			
			<h2>Ethical Banking</h2>
			
			<h3>Sign up to be the first to hear about Ethical Banking!</h3>
	...
	<div class="summary">
		...
		<p>
			<h3>Ethical Banking is almost ready!</h3>
			
			<p>
				We've spent a long time researching which bank is the most ethical and we're nearly ready to share the results! 
			</p>
	...
	<div class="center">
		...
		<form method="post" action="ethical-banking#select-state-link">
