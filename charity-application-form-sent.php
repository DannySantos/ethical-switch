<?php include 'header.php'; ?>
		...
		<div class="content-unpadded">
			...
			<div id="breadcrumb">
				...
				<ul>
					...
					<li>
						<a href="charity-partner-application">Apply to be a Charity Partner</a>
					</li> > 
	...
	<div class="text-pages">
		...
		if(isset($_POST['email'])) {
			...
			$email_subject = "Charity Application Form Submission";
		  ...
		  if(strlen($message) < 2) {
			...
			$error_message .= "Your message was too short!<br />";
		  ...
		  if(strlen($error_message) > 0) {
			...
			$email_message = "Ethical Switch Contact Form Submission:\n\n";
			...
			$email_message .= "Tell us About Your Project: ".clean_string($message)."\n";
		...
		<p class="center">Thank you for contacting us. We will reply to your e-mail as soon as we can.</p>
